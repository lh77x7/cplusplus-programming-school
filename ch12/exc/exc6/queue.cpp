...
bool Queue::enqueue(const Item & item)
{
    ...
    // w przypadku niepowodznia przydziału new zarzuci wyjątek std::bad_alloc
    add->item = item;               // ustawienie wskaźnika węzłów
...
/* kiedy klient trafia do kolejki, zapamiętywany jest bieżący czas systemowy, losowany
   jest też czas obsługi klienta (z zakresu od 1 do 3) */
